...
set1 <- create_settings(var1 = 4, var2 = 4, effect_size = 0, n1 = 25, n2 = 25, replications = 500)
set2 <- create_settings(var1 = 4, var2 = 4, effect_size = 0, n1 = 20, n2 = 30, replications = 500)
set3 <- create_settings(var1 = 4, var2 = 2, effect_size = 0, n1 = 25, n2 = 25, replications = 500)
set4 <- create_settings(var1 = 4, var2 = 2, effect_size = 0, n1 = 20, n2 = 30, replications = 500)
set5 <- create_settings(var1 = 4, var2 = 2, effect_size = 0, n1 = 30, n2 = 20, replications = 500)
